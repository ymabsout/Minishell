...
/*   Updated: 2024/02/12 22:32:04 by smoumni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../mini_shell.h"

static void export_no_args(t_list *head_env)
{
    char **arr;
...
static void lol(t_list *node, char *env_var)
{
    char **joined_var;
    char *final_form;
...
static void replace_env(t_list *node, char *env_var)
{
    char **arr;
...
static void add_env(t_list **head_env, char *env_var)
{
    t_list *node;
    char **arr;
    char *env_v;
...
static void export(t_list **head_env, char *env_var)
{
    t_list *curr;
    char **env_list;
    char **env_str;
...
static void export_plus(t_list **head_env, char *env_var)
{
    t_list *curr;
    char **env_list;
    char **env_str;
